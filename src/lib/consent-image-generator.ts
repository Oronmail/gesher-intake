    ...
    ">
      ...
      ">
        ...
        <p style="
          ...
          margin: 0;
        ">
          אני/אנו החתומים מטה, הורי/אפוטרופוסים של התלמיד/ה הנ"ל, נותנים בזאת את הסכמתנו המלאה 
          לעמותת "גשר אל הנוער" לקבל, לאסוף ולעבד את המידע האישי של ילדנו לצורך השתתפות 
          בתוכנית החינוכית והטיפולית של העמותה.
        </p>
        <p style="
          line-height: 1.8;
          color: #78350f;
          margin: 12px 0 0 0;
        ">
          אנו מאשרים כי המידע נמסר מרצוננו החופשי וכי אנו מבינים את מטרות השימוש במידע 
          לטובת קידום וסיוע לילדנו. ידוע לנו כי המידע יישמר בסודיות מלאה ויעשה בו שימוש 
          אך ורק למטרות הטיפול והליווי החינוכי במסגרת פעילות העמותה.
        </p>
      </div>
