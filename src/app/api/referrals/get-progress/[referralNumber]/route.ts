...
export async function GET(
  ...
  try {
    ...
    const formData = {
      ...
      parent1_name: sfData.Parent1_Name__c || '',
      parent1_phone: sfData.Parent1_Phone__c || '',
      parent1_occupation: sfData.Parent1_Occupation__c || '',
      parent1_profession: sfData.Parent1_Profession__c || '',
      parent1_income: sfData.Parent1_Income__c || '',
      parent2_name: sfData.Parent2_Name__c || '',
      parent2_phone: sfData.Parent2_Phone__c || '',
      parent2_occupation: sfData.Parent2_Occupation__c || '',
